class PlayBack:
    def __init__(self, playback):
        ...
        self.src = playback["playback"]["smil"]["video"]["src"]
        self.mime_type = playback["playback"]["smil"]["video"]["type"]
        self.license_token = playback["playback"]["smil"]["securityLicense"]["token"]

        url = self.playback["playback"]["smil"]["securityLicense"]["url"]
